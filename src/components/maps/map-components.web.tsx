      ...
      style.layers.forEach((layer) => {
        ...
        if (layer.type === "fill") {
          ...
          if (
            ...
            safeSetPaint(layer.id, "fill-color", "#513A66");
            ...
            safeSetPaint(layer.id, "fill-outline-color", "#7A5A96");
...
export const MapView = forwardRef<any, MapViewProps>(function WebMapView(
  ...
  useEffect(() => {
    ...
    setCurrentRegion(normalizeRegion(region));
    ...
    <WebMapContext.Provider value={contextValue}>
      ...
      <View style={[styles.container, style]}>
        ...
        {React.createElement("iframe", {
          ...
          key: `${currentRegion.latitude}-${currentRegion.longitude}-${currentRegion.latitudeDelta}-${currentRegion.longitudeDelta}`,
    ...
    React.createElement(
...

      {
        ...
        style: {
          ...
          boxShadow: `0 0 8px ${pinColor}, 0 0 18px ${pinColor}, 0 0 28px rgba(168,85,247,0.8)`,
        ...
        ? React.createElement(
...

            {
              ...
              style: {
                ...
                border: "1px solid rgba(232,121,249,0.8)",
