...
const WATER_EGG_ART = require('../../assets/images/footprints/eggs/water/wateregg.png');
const FIRE_EGG_ART = require('../../assets/images/footprints/eggs/fire/Inferno Core Egg.png');
