...
export const RELIC_ASSETS = {
  cosmicShard: {
    id: 'cosmic-shard', name: 'Cosmic Shard', icon: require('../../assets/images/relicsIcons/cosmicshard.png'),
  ...
  nebulaCrystal: {
    id: 'nebula-crystal', name: 'Nebula Crystal', icon: require('../../assets/images/relicsIcons/nebulacrystal.png'),
  ...
  starFragment: {
    id: 'star-fragment', name: 'Star Fragment', icon: require('../../assets/images/relicsIcons/starfragment.png'),
  ...
  auroraGem: {
    id: 'aurora-gem', name: 'Aurora Gem', icon: require('../../assets/images/relicsIcons/auroragem.png'),
  ...
  eclipseOrb: {
    id: 'eclipse-orb', name: 'Eclipse Orb', icon: require('../../assets/images/relicsIcons/eclipseorb.png'),
  ...
  forgottenIdol: {
    ...
    id: 'hidden-relic', name: 'Forgotten Idol', icon: require('../../assets/images/relicsIcons/forgottenidol.png'),
  ...
  abyssalBubble: {
    id: 'abyssal-bubble', name: 'Abyssal Bubble', icon: require('../../assets/images/relicsIcons/abyssalbubble.png'),
  ...
  stormCoreElement: {
    id: 'storm-core-element', name: 'Storm Core', icon: require('../../assets/images/relicsIcons/stormcoreelement.png'),
  ...
  lunarTablet: {
    id: 'lunar-tablet', name: 'Lunar Tablet', icon: require('../../assets/images/relicsIcons/lunartabletcollectible.png'),
  ...
  phoenixEmberCrystal: {
    id: 'phoenix-ember-crystal', name: 'Phoenix Ember', icon: require('../../assets/images/relicsIcons/phoenixembercrystal.png'),
  ...
  mysticalOracleEye: {
    id: 'mystical-oracle-eye', name: 'Mystical Oracle Eye', icon: require('../../assets/images/relicsIcons/mysticaloracleeye.png'),
  ...
  emeraldHeart: {
    id: 'emerald-heart', name: 'Emerald Heart', icon: require('../../assets/images/relicsIcons/emraldgreengem.png'),
  ...
  magmaCrown: {
    id: 'magma-crown', name: 'Magma Crown', icon: require('../../assets/images/relicsIcons/magmacrown.png'),
  ...
  radiantSolarSun: {
    id: 'radiant-solar-sun', name: 'Radiant Solar Sun', icon: require('../../assets/images/relicsIcons/radiantsolarsun.png'),
  ...
  ancientMysticalCoin: {
    id: 'ancient-mystical-coin', name: 'Ancient Mystical Coin', icon: require('../../assets/images/relicsIcons/ancientmysticalcoin.png'),
  ...
  fossilFang: {
    id: 'fossil-fang', name: 'Fossil Fang', icon: require('../../assets/images/relicsIcons/fossilfang.png'),
  ...
  dreamcapSpore: {
    id: 'dreamcap-spore', name: 'Dreamcap Spore', icon: require('../../assets/images/relicsIcons/dreamcapspore.png'),
  ...
  levitatingArmoredSeed: {
    id: 'levitating-armored-seed', name: 'Levitating Armored Seed', icon: require('../../assets/images/relicsIcons/levitatingarmoredseed.png'),
  ...
  dragonFlameScale: {
    id: 'dragon-flame-scale', name: 'Dragon Flame Scale', icon: require('../../assets/images/relicsIcons/dragonflamescale.png'),
  ...
  elegantGlassFlower: {
    id: 'elegant-glass-flower', name: 'Elegant Glass Flower', icon: require('../../assets/images/relicsIcons/elegantglassflower.png'),
  ...
  titanStone: {
    id: 'titan-stone', name: 'Titan Stone', icon: require('../../assets/images/relicsIcons/titanstone.png'),
  ...
  premiumSirenShell: {
    id: 'premium-siren-shell', name: 'Premium Siren Shell', icon: require('../../assets/images/relicsIcons/premiumsirenshell.png'),
  ...
  tidekeeperTrident: {
    id: 'tidekeeper-trident', name: 'Tidekeeper Trident', icon: require('../../assets/images/relicsIcons/tidekeepertrident.png'),
  ...
  frostRuneIceTablet: {
    id: 'frost-rune-ice-tablet', name: 'Frost Rune Ice Tablet', icon: require('../../assets/images/relicsIcons/frostruneicetablet.png'),
  ...
  meteorHeart: {
    id: 'meteor-heart', name: 'Meteor Heart', icon: require('../../assets/images/relicsIcons/meteorheart.png'),
  ...
  eternalFlame: {
    id: 'eternal-flame', name: 'Eternal Flame', icon: require('../../assets/images/relicsIcons/eternalflame.png'),
  ...
  saturnSeal: {
    id: 'saturn-seal', name: 'Saturn Seal', icon: require('../../assets/images/relicsIcons/saturnseal.png'),
  ...
  astralBeacon: {
    id: 'astral-beacon', name: 'Astral Beacon', icon: require('../../assets/images/relicsIcons/astralbeacon.png'),
  ...
  solarCrown: {
    id: 'solar-crown', name: 'Solar Crown', icon: require('../../assets/images/relicsIcons/solarcrown.png'),
  ...
  darkMoon: {
    id: 'dark-moon', name: 'Dark Moon', icon: require('../../assets/images/relicsIcons/darkmoon.png'),
  ...
  cometTear: {
    id: 'comet-tear', name: 'Comet Tear', icon: require('../../assets/images/relicsIcons/comettear.png'),
  ...
  ancientTempleKey: {
    id: 'ancient-temple-key', name: 'Ancient Temple Key', icon: require('../../assets/images/relicsIcons/ancienttemplekey.png'),
  ...
  celestialKey: {
    id: 'celestial-key', name: 'Celestial Key', icon: require('../../assets/images/relicsIcons/celestialkey.png'),
  ...
  ancientProphecyScroll: {
    id: 'ancient-prophecy-scroll', name: 'Ancient Prophecy Scroll', icon: require('../../assets/images/relicsIcons/ancientprophecyscroll.png'),
  ...
  eternalHourglass: {
    id: 'eternal-hourglass', name: 'Eternal Hourglass', icon: require('../../assets/images/relicsIcons/eternalhourglass.png'),
  ...
  sentinelCrest: {
    id: 'sentinel-crest', name: 'Sentinel Crest', icon: require('../../assets/images/relicsIcons/sentinelcrest.png'),
  ...
  crimsonDragonSoul: {
    id: 'crimson-dragon-soul', name: 'Crimson Dragon Soul', icon: require('../../assets/images/relicsIcons/crimsondragonsoul.png'),
  ...
  ancientSpiritMask: {
    id: 'ancient-spirit-mask', name: 'Ancient Spirit Mask', icon: require('../../assets/images/relicsIcons/ancientspiritmask.png'),
  ...
  crownOfAges: {
    id: 'crown-of-ages', name: 'Crown of Ages', icon: require('../../assets/images/relicsIcons/crownofages.png'),
  ...
  creationTear: {
    id: 'creation-tear', name: 'Creation Tear', icon: require('../../assets/images/relicsIcons/creationtear.png'),
  ...
  prismaticShard: {
    id: 'prismatic-shard', name: 'Prismatic Shard', icon: require('../../assets/images/relicsIcons/prismaticshard.png'),
  ...
  voidPearl: {
    id: 'void-pearl', name: 'Void Pearl', icon: require('../../assets/images/relicsIcons/voidpearl.png'),
...
export const UNDISCOVERED_RELIC_ICON = require('../../assets/images/relicsIcons/undiscovered.png');
