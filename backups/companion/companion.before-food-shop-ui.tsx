          ...
          <FeedView
            ...
            onSelectFood={(foodId) => {
              ...
              if (quantity <= 0) {
                ...
                setFeedMessage(
                  `${food?.name ?? 'This food'} is locked. Earn it from verified mission rewards.`,
                );
                return;
              }
    ...
    <>
      ...
      <View style={styles.subHero}>
        ...
        <Text style={styles.subHeroText}>
          Earn food from verified missions, then feed it
          to gain Companion Growth HP and Explorer XP.
        </Text>
      </View>
      ...
      <View style={styles.noticeCard}>
        ...
        <Text style={styles.noticeText}>
          Food quantities are synced with Supabase.
          Hunger is not implemented yet, so only real
          inventory, Growth HP, level, and XP are used.
        </Text>
      </View>
        ...
        {FOOD_PREVIEWS.map((food) => {
          ...
          return (
            ...
            >
              ...
              <View style={styles.foodRewardRow}>
                <Text style={styles.foodHpText}>
                  +{food.hp} HP
                </Text>

                <Text style={styles.foodXpText}>
                  +{food.xp} XP
                </Text>
              </View>
      ...
      {selectedFood ? (
        <View style={styles.selectedFoodSummary}>
          <Image
          ...
          <View style={styles.selectedFoodCopy}>
            ...
            <Text style={styles.selectedFoodDetail}>
              +{selectedFood.hp} Growth HP • +{selectedFood.xp} Explorer XP
            </Text>
